...
Get some Ward-level up to date population estimates from here:
...
summary_table <- wards_no_geom %>%
  mutate(OptionsAll = recode(OptionsAll,
                             "BHWB" = "Brighton & Hove, Worthing and Burgess Hill",
                             "HCE"  = "Horsham, Crawley and Mid Sussex",
                             "ELW"  = "Eastbourne, Lewes and Wealden",
                             "HBR"  = "Hastings, Bexhill and Rother", 
                             "CH" = "Chichester, Bognor and Littlehampton ")) %>%
  group_by(OptionsAll) %>%
